        ...
        <>
          ...
          <div style={{ padding: "10px 12px", borderBottom: "1px solid var(--border-default)", background: "var(--bg-section-alt)" }}>
            ...
            {sendMsg && (
              ...
              >
                <p style={{ margin: 0, fontSize: "12px", fontWeight: 600, color: sentVia === "email" ? "var(--success)" : "var(--text-heading)" }}>
                ...
                {visible.map(inv => {
                  ...
                  return (
                    <tr key={inv.id}>
                      ...
                      <td style={{ ...cell, fontSize: "12px", color: isExpired ? "var(--danger)" : "var(--text-muted)" }}>
